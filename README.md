<br/>
<p align="center">
<a href="https://XDCBridge.finance/" target="_blank">
...
[XDCBridge](https://XDCBridge.finance/) — cross-chain interoperability
...
More information about the project can be also found in the [documentation portal](https://docs.XDCBridge.finance/)
<br/>

# XDCBridge Smart Contracts
...
```
The detailed methods' description can be found in the contracts themselves or in the [documentation](https://docs.XDCBridge.finance/).
...
## [How Transfers Works](https://docs.XDCBridge.finance/the-core-protocol/transfers)
